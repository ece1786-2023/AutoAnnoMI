"""Script to run the few-shot prompt on reflection test examples and get the 
results.

To run:

python experiments/00_reflection_baseline/get_baseline_results.py \
    --prompt_file prompts/reflection/baseline.txt \
    --test_dir data/split/reflection_test_examples \
    --output_file data/experiment_outputs/reflection_baseline.csv
"""
